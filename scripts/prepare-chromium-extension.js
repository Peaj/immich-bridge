...
const outputRoot = path.join(repoRoot, 'artifacts', 'chromium-extension', 'source');
...
console.log(`Prepared Chromium extension source at ${path.relative(repoRoot, outputRoot)}`);
